...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-navy relative overflow-hidden flex items-center justify-center px-4 py-8">
              ...
              <>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      type="text" 
                      className="input w-full pl-12 font-mono" 
                      placeholder="27AAAPZ1234N1Z5"
                      value={gstin}
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 flex items-center space-x-2">
                    ...
                    <img src="/udyam-logo.jpeg" alt="Udyam" className="h-5" />
                  </label>
                  <div className="relative">
                    <div className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      type="email" 
                      className="input w-full pl-12" 
                      placeholder="regulator@rbi.org.in"
